    ...
    <footer className="bg-green-900 text-white">
      <div className="container mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-green-200 text-lg mb-4">
              Stay updated on new eco-friendly products and promotions.
            </p>
            <div className="flex">
              <input
                type="email"
                placeholder="Your email"
                className="px-4 py-2 rounded-l-md text-gray-800 w-full focus:outline-none focus:ring-2 focus:ring-green-600"
              />
        ...
        <div className="border-t border-green-700 mt-8 pt-6 text-center text-green-200">
          <p>
            &copy; {new Date().getFullYear()} Green Marketplace. All rights
            reserved.
          </p>
        </div>
      </div>
