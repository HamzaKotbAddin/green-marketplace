...
const Certification = () => {
  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      // Process predictions and set result
      ...
      setResult({
        ...
        isEcoFriendly: true,
        details: [
          "Detected sustainable material: bamboo",
          "Detected eco-feature: biodegradable"
        ]
      });
    } catch (error) {
  ...
  return (
    <div className="certification-container">
      ...
      <p className="certification-description">
        Upload a product image to verify if it meets eco-friendly standards.
        Our AI will analyze the image and determine sustainability metrics.
      </p>
