...
const ManageProductsPage = ({ setCurrentPage }) => {
  ...
  const handleUpdate = async (e) => {
    ...
    if (!editingProduct.title || !editingProduct.description || !editingProduct.price || !editingProduct.category) {
    ...
    try {
      ...
      setProducts(products.map(p => 
        p.id === editingProduct.id ? { ...updatedProduct, createdAt: p.createdAt } : p
      ));
  ...
  const handleDelete = async (productId) => {
    try {
      ...
      if (productToDelete.image && productToDelete.image.includes('firebasestorage')) {
        try {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-green-800 mb-6">Manage Products</h1>
      <p className="mb-6">View, edit, and delete products in your eco-friendly marketplace.</p>
      ...
      {isLoading && !editingProduct ? (
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold text-green-700 mb-4">Edit Product</h2>
            ...
            <div className="mb-6">
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => setEditingProduct({...editingProduct, isEco: e.target.checked})}
            ...
            <tbody className="divide-y divide-gray-200">
              {products.map((product) => (
                <tr key={product.id} className="hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">{product.category?.replace('_', ' ') || 'N/A'}</td>
                  <td className="py-3 px-4">
