...
const PaymentPage = ({ cart, setCurrentPage }) => {
  ...
  return (
    <div className="max-w-md mx-auto p-4">
      ...
      <p className="text-gray-700 mb-4">Total: <span className="font-bold">${totalAmount}</span></p>

      <div className="space-y-6">
        {/* PayPal Payment Option */}
        <div className="border rounded-lg p-4 bg-gray-50">
          <h2 className="text-lg font-semibold mb-3">Pay with PayPal</h2>
          <PayPalScriptProvider options={{ "client-id": "AQU38Dse_L0DozQKMD3t0pTnAi7K9-Ff5aG7eEuAE3rj0VZMyNFK5oAq8aZivAoupIGO8eqvo9MpEAGz" }}>
            <PayPalButtons
